namespace VentureSketch
{
    ...
    public static class BundleConfig
    {
        ...
        private static void AddJavaScript(BundleCollection bundles)
        {
            ...
            // Microsoft jQuery Validate Unobtrusive Ajax
            //Bundle jqueryUnobtrusiveAjaxBundle = new ScriptBundle("~/bundles/jquery/jqueryunobtrusiveajax", ContentDeliveryNetwork.Microsoft.JQueryUnobtrusiveAjax).Include("~/Scripts/jquery.unobtrusive-ajax*");
            //bundles.Add(jqueryUnobtrusiveAjaxBundle);
